...
Boat.java
Legacy class representing a boat with its own fuel and travel logic.
Handles fuel consumption, travel time, and cost calculations specific to boats.
Used by BoatAdapter to conform to the IVehicle interface.
*/
