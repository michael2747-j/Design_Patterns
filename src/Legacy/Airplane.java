...
Airplane.java
Legacy class representing an airplane with its own fuel and travel logic.
Handles fuel consumption, travel time, and cost calculations specific to airplanes.
Used by AirplaneAdapter to conform to the IVehicle interface.
*/
