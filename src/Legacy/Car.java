...
Car.java
Legacy class representing a car with its own fuel and travel logic.
Handles fuel consumption, travel time, and cost calculations specific to cars.
Used by CarAdapter to conform to the IVehicle interface.
*/
